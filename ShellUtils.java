package config.sds.com.config;

/**
 * Created by lidan on 17-8-24.
 */
...
public class ShellUtils {
    ...
    public static CommandResult execCommand(List commands, boolean isRoot) {
        return execCommand(commands == null ? null : (String[])commands.toArray(new String[] {}), isRoot, true);
    }
    ...
    public static CommandResult execCommand(List commands, boolean isRoot, boolean isNeedResultMsg) {
        return execCommand(commands == null ? null : (String[])commands.toArray(new String[] {}), isRoot, isNeedResultMsg);
    }
